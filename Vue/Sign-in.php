...
require_once ("../Database/Db.php");
    ...
    {     
        header("location:accueillClient.php");
    }
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="col-12 col-lg-10 mx-auto ">
			  <div class="card" style="border-radius: 1rem;">
				<div class="card-body p-5">
				  ...
				  <h1 class="mb-5 text-center">Connectez-vous pour profiter des tarifs réservés aux membres</h1>
  
				  <form class="was-validated" " method="POST" action="../Controllers/Login.php">
					...
					<!-- Submit button -->
					<center><button type="submit" class="btn  btn-warning btn-rounded btn-block " name="seconnecter">Se Connecter</button></center><br><br>
                    <hr>
                    <div class="col-4">   
                    <p><a href="#" class="link ">Vous n'avez pas de Compte ?</a></p>    
